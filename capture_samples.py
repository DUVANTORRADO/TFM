...
def capture_samples(path, margin_frame=2, min_cant_frames=5):
    ...
    ##obtener la cantidad de muestras existentes
        ...
        while video.isOpened():
            ...
            if there_hand(results):
                ...
                if count_frame > margin_frame: 
                    cv2.putText(image, 'Capturando...', FONT_POS, FONT, FONT_SIZE, (255,255,255))
                ...
                frames = []
                count_frame = 0
                cv2.putText(image, 'Realiza la palabra con tus manos...', FONT_POS, FONT, FONT_SIZE, (255,255,255))
                
            draw_keypoints(image, results)
            cv2.imshow(f'Tomando las muestras de "{os.path.basename(path)}"', image)
